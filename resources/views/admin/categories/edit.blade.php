...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="mb-8">
        <h2 class="text-3xl font-bold text-gray-900 dark:text-white">Edit Category</h2>
        <p class="text-base text-gray-600 dark:text-gray-400 mt-2">Update category information and settings for {{ $category->name }}.</p>
    </div>
    ...
    <form action="{{ route('admin.categories.update', $category) }}" method="POST" class="space-y-8">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border dark:border-gray-700 p-8">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div>
                    <label class="block text-base font-semibold text-gray-700 dark:text-gray-300 mb-3">Prefix Code * <span class="text-gray-500 text-sm font-normal">(max 10 chars)</span></label>
            ...
            <div class="mt-6">
                ...
                <textarea name="description" rows="4" 
                          class="w-full rounded-xl border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white text-base py-3 px-4 focus:ring-2 focus:ring-primary-500 focus:border-primary-500 transition-all duration-200 resize-none">{{ old('description', $category->description) }}</textarea>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border dark:border-gray-700 p-8">
            <div class="flex items-center gap-3 mb-6 pb-4 border-b dark:border-gray-700">
                ...
                <div>
                    <h3 class="text-xl font-bold text-gray-900 dark:text-white">Category Settings</h3>
                    <p class="text-sm text-gray-500 dark:text-gray-400">Control category availability</p>
                </div>
            </div>

            <div class="flex items-center p-5 bg-gradient-to-r from-gray-50 to-gray-100 dark:from-gray-700/30 dark:to-gray-700/50 rounded-xl border-2 border-gray-200 dark:border-gray-600">
                <input type="hidden" name="is_active" value="0">
                <input type="checkbox" name="is_active" value="1" {{ old('is_active', $category->is_active) ? 'checked' : '' }} 
                       class="w-5 h-5 rounded-lg border-gray-300 dark:border-gray-600 text-primary-600 focus:ring-2 focus:ring-primary-500 dark:bg-gray-700 transition-all duration-200">
                <label class="ml-4 text-base font-semibold text-gray-700 dark:text-gray-300">Active Category</label>
                <p class="ml-auto text-sm text-gray-500 dark:text-gray-400">Enable for asset creation</p>
            </div>
        </div>
